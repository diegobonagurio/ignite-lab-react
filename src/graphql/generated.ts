...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, id: string, description?: string | null, slug: string, videoId: string, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };

export type GetLessionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessionsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
